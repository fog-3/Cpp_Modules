...
int main()
{
    ...
    AMateria* droppedItem = ((Character*)original)->getMateria(0); // Assuming you added a getter helper, otherwise skip
    ...
    delete copy;
    delete factory;
    // delete droppedItem; // If you saved it
    ...
    // CLEANUP
    delete extra; // We must delete the one that didn't fit!
    delete cloud;
    delete spellBook;
